                    ...
                    <form method="POST" action="{{ route('admin.usuarios.store') }}">
                        ...
                        @if ($errors->any())
                            <div class="mb-4 font-medium text-red-600 dark:text-red-400">
                                Se encontraron {{ $errors->count() }} errores al intentar crear el usuario.
                            </div>
                        @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Si se deja vacío, la contraseña será **12345678**.</p>
                            ...
                            <div class="md:col-span-2">
                                <x-input-label for="foto" :value="__('URL de Foto de Perfil (Opcional)')" />
